...
echo "<script>(function(){try{var t=localStorage.getItem('campus-theme')||(window.matchMedia('(prefers-color-scheme: dark)').matches?'dark':'light');document.documentElement.setAttribute('data-theme',t);}catch(e){}})();</script>" . "\n";
    ...
    echo '<link rel="icon" type="image/svg+xml" href="assets/img/favicon.svg?v=20260920">' . "\n";
    echo '<link rel="stylesheet" href="assets/css/style.css?v=20260920a">' . "\n";
    echo '<link rel="stylesheet" href="assets/css/design-system.css?v=20260920a">' . "\n";
    renderCampusStyles();
    echo '</head>' . "\n";
    echo '<body>' . "\n";
...
function renderSiteFooter($opts = []) {
    ...
    renderMobileTabbar();
    renderCampusScripts();
    echo '<script src="assets/js/app.js?v=20260816r9"></script>' . "\n";
    echo '</div>' . "\n";
    echo '</div>' . "\n";
